 ...
 */
PARAM_DEFINE_INT32(LQGQ_ENABLED, 1);
 ...
 * @group Local Position Estimator
 */
PARAM_DEFINE_INT32(LQGQ_INTEGRATE, 1);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(LQGQ_FLW_XY, 0.01f);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(LQGQ_SNR_Z, 0.2f);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(LQGQ_LDR_Z, 0.03f);
 ...
 * @max 2
 */
PARAM_DEFINE_FLOAT(LQGQ_ACC_XY, 0.0454f);
 ...
 * @max 2
 */
PARAM_DEFINE_FLOAT(LQGQ_ACC_Z, 0.0454f);
 ...
 * @max 3
 */
PARAM_DEFINE_FLOAT(LQGQ_BAR_Z, 1.0f);
 ...
 * @max 5
 */
PARAM_DEFINE_FLOAT(LQGQ_GPS_XY, 2.0f);
 ...
 * @max 20
 */
PARAM_DEFINE_FLOAT(LQGQ_GPS_Z, 10.0f);
 ...
 * @max 2
 */
PARAM_DEFINE_FLOAT(LQGQ_GPS_VXY, 0.275f);
 ...
 * @max 2
 */
PARAM_DEFINE_FLOAT(LQGQ_GPS_VZ, 0.237f);
 ...
 * @max 5.0
 */
PARAM_DEFINE_FLOAT(LQGQ_EPH_MAX, 3.0f);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(LQGQ_VIS_XY, 0.5f);
 ...
 * @max 2
 */
PARAM_DEFINE_FLOAT(LQGQ_VIS_Z, 0.5f);
 ...
 * @max 1
 */
PARAM_DEFINE_INT32(LQGQ_NO_VISION, 0);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(LQGQ_VIC_P, 0.05f);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(LQGQ_PN_P, 0.0f);
 ...
 * @max 5
 */
PARAM_DEFINE_FLOAT(LQGQ_PN_V, 0.0f);
 ...
 * @max 1
 */
PARAM_DEFINE_FLOAT(LQGQ_PN_B, 1e-8f);
 ...
 * @max 1000
 */
PARAM_DEFINE_FLOAT(LQGQ_BETA_MAX, 1000.0f);
